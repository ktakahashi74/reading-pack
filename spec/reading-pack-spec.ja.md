...
| [reading-pack参照実装プロファイル](reading-pack-reference-implementation.ja.md) | このリポジトリのproject形式、CLI、取込、transaction、plugin境界 | 他社実装がReading Pack適合を名乗るための条件 | `Built with reading-pack toolkit 0.7.0` |
