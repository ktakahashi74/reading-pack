...
| [reading-pack Reference Implementation Profile](reading-pack-reference-implementation.en.md) | This repository's project format, CLI, import, transaction, and plugin boundaries | Conditions another implementation must meet to claim Reading Pack conformance | `Built with reading-pack toolkit 0.8.0` |
