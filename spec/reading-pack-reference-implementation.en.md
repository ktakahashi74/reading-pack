PROFILE | name=reading-pack Reference Implementation Profile | version=0.8.0 | status=alpha | language=en | primary=false | date=2026-09-22 | author=Koichi Takahashi | code_license=MIT | document_license=CC BY 4.0

# reading-pack Reference Implementation Profile 0.8.0 (alpha)
...
**RPI-020** Implementations of this profile MAY display `Built with reading-pack toolkit 0.8.0`. This does not replace a format- or production-conformance claim.
